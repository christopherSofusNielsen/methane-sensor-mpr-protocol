...
void test_init(){
    ...
    TEST_ASSERT_EQUAL_INT16(3, state.lastSubId);

    TEST_ASSERT_EQUAL_INT8(2, state.nCollections);
    ...
    //type
    TEST_ASSERT_EQUAL_INT8(T_INT16, state.collections[0].type);
    TEST_ASSERT_EQUAL_INT8(T_INT16, state.collections[1].type);
